...
class PDSerial {
     ...
     */
    async doReadWithTimeout(timeoutMs, readFn, ...readFnArgs) {
...
class PlaydateDevice {
     ...
     * The input bitmap must also contain 400 x 240 pixels
     */
    async sendBitmapIndexed(indexed) {
     ...
     */
    async evalLuaPayload(payload, waitTime = 50) {
 ...
 */
async function requestConnectPlaydate() {
    assertUsbSupported();
...
export { PDButtonBitmaskMap, PDButtonNameMap, PDSerial, PLAYDATE_BAUDRATE, PLAYDATE_BUFFER_SIZE, PLAYDATE_HEIGHT, PLAYDATE_PID, PLAYDATE_VID, PLAYDATE_WIDTH, PlaydateDevice, USB_FILTER, assertUsbSupported, isUsbSupported, kButtonA, kButtonB, kButtonDown, kButtonLeft, kButtonLock, kButtonMenu, kButtonRight, kButtonUp, requestConnectPlaydate, version };
